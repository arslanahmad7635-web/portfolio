...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "sticky top-0 z-10 bg-foreground border-b border-zinc-200 dark:border-zinc-800 text-background",
  ...
  (
    ...
    return (
      <th
        ref={ref}
        className={cn(
          "align-middle font-semibold text-background transition-all duration-200 select-none",
